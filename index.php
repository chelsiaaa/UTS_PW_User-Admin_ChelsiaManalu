...
<head>
    ...
    <style>
        ...
        .logout-btn { background-color: #007BFF; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-size: 14px; }
        .logout-btn:hover { background-color: #007BFF; }
        ...
        .badge-success { background: #007BFF; color: white; }
        .badge-warning { background: #007BFF; color: black; }
        .badge-danger { background: #007BFF; color: white; }
    </style>
</head>
<body>
...
<div class="form-container">
        ...
        <form method="POST" action="">
            ...
            <input type="text" name="nama" required placeholder="Contoh: Teh Botol">
            
            <label>Kategori</label>
            <input type="text" name="kategori" required placeholder="Contoh: Minuman">
            
            <label>Harga</label>
            <input type="number" name="harga" min="0" required placeholder="Contoh: 10000">
            
            <label>Stok</label>
            <input type="number" name="stok" min="0" required placeholder="Contoh: 100">
